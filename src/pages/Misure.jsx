          ...
          <div className="grid grid-cols-2 gap-4 justify-items-center">
            ...
            return (
              <button
                ...
                className="flex flex-col items-center justify-center w-24 h-24 border-[6px] shadow-md hover:shadow-lg hover:scale-105 transition-all active:scale-95 rounded-[10015px]">
