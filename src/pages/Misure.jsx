          ...
          <div className="grid grid-cols-2 gap-4 justify-items-center">
            ...
            return (
              <button
                ...
                className="flex flex-col items-center justify-center w-32 h-32 rounded-full border-4 border-accent shadow-md hover:shadow-lg hover:scale-105 transition-all active:scale-95 bg-[hsl(var(--primary))]">
